...
-----
    python3 tools/tp2/build_needle_1m_corpus.py \
        --out-dir /path/to/ninfer-models/needle-1m \
        --tokenizer /path/to/ninfer-models/unsloth-nvfp4
...
def main() -> int:
    ...
    ap.add_argument("--out-dir", default="/path/to/ninfer-models/needle-1m")
    ap.add_argument(
        "--cache-dir",
        default=None,
    ...
    ap.add_argument("--tokenizer", default="/path/to/ninfer-models/unsloth-nvfp4")
