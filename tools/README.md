...
## Generated ranking fixture

Some artifact-conversion helpers reference `tools/freq_corpus/fixtures/ranking/ranking.train.counts.i64`.
That generated ranking fixture is intentionally not included in the public Riftline source snapshot.
Provide or regenerate the fixture before running conversion workflows that require the fixed draft-head shortlist.
