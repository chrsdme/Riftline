...
struct Options {
    ...
    // 0 (default): the target resolves this to its own default boundary. Only meaningful with
    // --split-mode layer; parse_options() hard-errors if it is set without that mode.
