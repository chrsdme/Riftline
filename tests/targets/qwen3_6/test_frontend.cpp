...
const fi::Tokenizer& official_tokenizer() {
    static const std::string tokenizer_json =
        read_file("/path/to/models/qwen/Qwen3.6-27B/base-hf-bf16/tokenizer.json");
    static const std::string tokenizer_config_json =
        read_file("/path/to/models/qwen/Qwen3.6-27B/base-hf-bf16/tokenizer_config.json");
    static const std::string generation_config_json =
        read_file("/path/to/models/qwen/Qwen3.6-27B/base-hf-bf16/generation_config.json");
