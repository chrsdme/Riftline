...
| artifact | `/path/to/ninfer-models/huihui-nvfp4/qwen3_8_27b_nvfp4.ninfer` (`qwen3_8_27b` / `nvfp4`, 18.99 GiB as read) |
...
tests/data/tp1-golden/record.sh \
  <ninfer-binary> \
  /path/to/ninfer-models/huihui-nvfp4/qwen3_8_27b_nvfp4.ninfer \
  <output-dir>
```
