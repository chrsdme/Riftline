...
The generated ranking fixture itself is not included in the public Riftline source snapshot. Provide
or regenerate the fixture before reproducing conversion steps that require it.
...
python3 -m tools.convert.qwen3_6_27b.convert_nvfp4 \
  --model /path/to/models/qwen/Qwen3.6-27B/base-hf-bf16 \
  --nvfp4-model /path/to/models/qwen/Qwen3.6-27B/vllm-nvfp4-bf16 \
